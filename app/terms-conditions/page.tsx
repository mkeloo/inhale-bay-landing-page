    ...
    return (
        <>
            ...
            <div className="px-6 py-10 pt-20 max-w-3xl mx-auto">
                ...
                <p className="mb-4">
                    Welcome to Inhale Bay Smoke Shop  ("we", "us", or "our"). By accessing or using our website, you agree to comply with and be bound by the following terms and conditions. Please read them carefully.
                </p>
                ...
                <p className="mb-4">
                    We do not sell any products online. All products mentioned on this website are available exclusively at our physical store located at <a href="https://www.google.com/maps/place/Inhale+Bay+Smoke+Shop/"
                        target="_blank"
                        rel="noopener noreferrer" className="text-blue-600 underline">5751 N Main St, Suite #108, Jacksonville, FL 32208</a>.
                </p>
                ...
                <p className="mb-4">
                    All content on this website, including text, graphics, logos, and images, is the property of Inhale Bay Smoke Shop and is protected by intellectual property laws.
                </p>
                ...
                <p className="mb-4">
                    These terms and conditions are governed by the laws of Florida, without regard to its conflict of law principles.
                </p>
                ...
                <p className="mb-4">
                    If you have any questions about these terms, please submit the <a href="https://inhalebaysmokeshop.com/#contact" className="text-blue-600 underline">Contact Us</a> form.
                </p>
