...
const BespokeAdsPage = () => {
  return (
    <div className='bg-black w-full h-screen flex flex-col items-center justify-center space-y-10'>
      <h1 className='text-4xl font-bold font-grotesk animate-ping'>No! Go Back Home!</h1>
      <button className='bg-lime-400 text-black px-4 py-3 rounded-md ml-4 animate-bounce'>
        <a href='/' className='font-bold font-oxanium text-2xl flex items-center justify-center space-x-3'>
          Home
          <ArrowBigLeftDash strokeWidth={2} size={34} />
        </a>
      </button>
    </div>
  )
