...
import flowerSkeleton from '@/public/assets/skeleton/flower_placeholder.webp'
import Image from 'next/image'

export default function SkeletonFlowerCard() {
    return (
        <div className="relative h-[420px] my-4 w-[102%] bg-gradient-to-tr from-indigo-400 to-purple-600 flex flex-col items-center justify-between rounded-2xl shadow-md overflow-hidden">
            ...
            <div className='w-full h-fit-content flex flex-col items-center justify-center'>
                <div className='w-full h-40 pb-10 flex items-center justify-center relative z-2 blur-[1px] animate-pulse'>
                    <Image src={flowerSkeleton} alt="Vape Placeholder" width={300} height={300} className='w-60 h-60 object-contain relative z-10 pb-4 rotate-12' />
                </div>
